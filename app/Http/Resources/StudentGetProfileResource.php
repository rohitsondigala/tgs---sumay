...
class StudentGetProfileResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $returnData['data']['university_name'] = $this->student_detail->university_name;
        $returnData['data']['college_name'] = $this->student_detail->college_name;
        $returnData['data']['preferred_language'] = $this->student_detail->preferred_language;
        $returnData['data']['other_information'] = $this->student_detail->other_information;
        ...
        if (!empty($this->student_subjects) && count($this->student_subjects)) {
            $i = 0;
