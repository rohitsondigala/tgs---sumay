                    ...
                    <div class="col-md-4">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 mb-4">
                                ...
                                {!! Form::text('price_month_3',null,['class'=>'form-control input-lg','placeholder'=>'Amount']) !!}
                            ...
                            <div class="form-group col-md-12 mb-4">
                                ...
                                {!! Form::text('price_month_6',null,['class'=>'form-control input-lg','placeholder'=>'Amount']) !!}
                            ...
                            <div class="form-group col-md-12 mb-4">
                                ...
                                {!! Form::text('price_month_12',null,['class'=>'form-control input-lg','placeholder'=>'Amount']) !!}
                            ...
                            <div class="form-group col-md-12 mb-4">
                                ...
                                {!! Form::text('price_month_24',null,['class'=>'form-control input-lg','placeholder'=>'Amount']) !!}
                            ...
                            <div class="form-group col-md-12 mb-4">
                                ...
                                {!! Form::text('price_month_36',null,['class'=>'form-control input-lg','placeholder'=>'Amount']) !!}
